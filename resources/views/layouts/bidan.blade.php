        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse show" id="sidebarMenu">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.data-ibu.index') }}">
                            <i class="fa-solid fa-users"></i> Data Ibu
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.konsultasi.index') }}">
                            <i class="fa-solid fa-comments"></i> Konsultasi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.booking.index') }}">
                            <i class="fa-solid fa-calendar-check"></i> Booking
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.edukasi.index') }}">
                            <i class="fa-solid fa-book-open-reader"></i> Edukasi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.risiko.index') }}">
                            <i class="fa-solid fa-heart-exclamation"></i> Penilaian Risiko
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('bidan.laporan.index') }}">
